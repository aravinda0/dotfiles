...
keys = [
    ...
    EzKey("M-C-h", lazy.layout.resize("left", 75)),
    EzKey("M-C-l", lazy.layout.resize("right", 75)),
    EzKey("M-C-k", lazy.layout.resize("up", 75)),
    EzKey("M-C-j", lazy.layout.resize("down", 75)),
