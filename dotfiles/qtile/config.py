...
keys = [
    ...
    EzKey("M-S-h", lazy.layout.resize("left", 85)),
    EzKey("M-S-l", lazy.layout.resize("right", 85)),
    EzKey("M-S-k", lazy.layout.resize("up", 85)),
    EzKey("M-S-j", lazy.layout.resize("down", 85)),
    EzKey("C-S-r", lazy.layout.rename_tab()),
    EzKey("M-C-h", lazy.layout.swap("left")),
    EzKey("M-C-S-l", lazy.layout.swap("right")),
    EzKey("M-C-S-k", lazy.layout.swap("up")),
    EzKey("M-C-S-j", lazy.layout.swap("down")),
    EzKey("M-C-S-d", lazy.layout.swap_tabs("previous")),
    EzKey("M-C-S-f", lazy.layout.swap_tabs("next")),
